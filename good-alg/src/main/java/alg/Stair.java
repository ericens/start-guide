...
public class Stair {
    ...
    public void climbStairsTest() {
        ...
        log.info("climb: {}", climbStairs(1));
        log.info("climb: {}", climbStairs(2));
        log.info("climb: {}", climbStairs(3));
        log.info("climb: {}", climbStairs(4));
        log.info("climb: {}", climbStairs(5));

        log.info("climb2: {}", climbStairs(1));
        log.info("climb2: {}", climbStairs(2));
        log.info("climb2: {}", climbStairs(3));
        log.info("climb2: {}", climbStairs(4));
        log.info("climb2: {}", climbStairs(5));
    }
