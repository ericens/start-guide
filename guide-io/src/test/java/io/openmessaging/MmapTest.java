...
public class MmapTest {
    ...
    String dir = "/Users/ericens/tmp/test/";
    ...
    private final static long _10G = 10L * 1024 * 1024 * 1024;
    ...
    public void test1() throws Exception {
        ...
        ensureDirOK(dir);
        RandomAccessFile memoryMappedFile = new RandomAccessFile(dir + "test1.txt", "rw");

        long fileSize = _10G;

        Random random = new Random();
        // Mapping a file into memory,ma下面直接报错。java.lang.IllegalArgumentException: Negative size, 有比较最大max int, 1.99999G
        ...
        System.out.println("Writing to Memory Mapped File is completed"+ (System.currentTimeMillis()-start));
    ...
    public void test2() throws Exception {
        ensureDirOK(dir);
        RandomAccessFile memoryMappedFile = new RandomAccessFile(dir + "test2.txt", "rw");
